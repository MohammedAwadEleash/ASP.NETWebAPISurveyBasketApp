...
{
    public class NotificationServics(ApplicationDbContext context , 
        ...
        IEmailSender emailSender) : INotificationService
    {
        ...
        public async  Task SendNewPollsNotification(int? pollId = null)
        {
            ...
            if(pollId.HasValue)
            {
                ...
                polls = await _context.Polls.Where(p => p.StartsAt == DateOnly.FromDateTime(DateTime.UtcNow) && p.IsPublished)
